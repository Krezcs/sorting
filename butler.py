...
commands = {
    'hello':        (hello_user,            ' -> just greeting'),
    'add contact':  (contact_adder,         ' -> adds a new contact'),
    '+c':           (contact_adder,         ' -> adds a new contact (short command)'),
    ...
    'save':         (saver,                 ' -> save all changes to file'),
    'load':         (loader,                ' -> load the last version of the Address Book'),
    'help':         (helper,                ' -> show the list of all supported commands'),
    'add note':     (note_adder,            ' -> adds a note with or without a hashtag'),
    '+n':           (note_adder,            ' -> adds a note with or without a hashtag (short command)'),
